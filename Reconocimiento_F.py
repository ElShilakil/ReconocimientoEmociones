import cv2
import os
from fer import FER  # Importar el detector de emociones FER

dataPath = r'C:\Users\suare\Desktop\Reconocimiento Facial\Data'  # Usar cadena cruda para evitar errores de escape
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        if emotion is not None:
            cv2.putText(frame, f'Emoción: {emotion}', (x, y-30), 2, 1.1, (0, 255, 0), 1, cv2.LINE_AA)
